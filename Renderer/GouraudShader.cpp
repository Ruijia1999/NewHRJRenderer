...
HRJRenderer::Vector3 HRJRenderer::GouraudShader::vertexShader(const HRJRenderer::Vector3& i_vec, const HRJRenderer::Vector3& i_normal, int index, const Color& i_color, const Draw::ConstantBuffer& constantBuffer) {
...
COLORREF HRJRenderer::GouraudShader::fragmentShader(const HRJRenderer::Vector3& barycentric, const Draw::ConstantBuffer& constantBuffer) {
